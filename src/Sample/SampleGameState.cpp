...
namespace Demo
{
    SampleGameState::SampleGameState( const Ogre::String &helpDescription ) :
        TutorialGameState( helpDescription )
    {
    }
    //-----------------------------------------------------------------------------------
    void SampleGameState::createScene01(void)
    {
        ...
        Ogre::Item *item = sceneManager->createItem( "ogrehead.mesh Imported",
    ...
    void SampleGameState::keyReleased(const SDL_KeyboardEvent &arg)
    {
